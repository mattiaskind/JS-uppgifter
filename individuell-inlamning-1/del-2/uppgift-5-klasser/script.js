class Person {
  ...
  watchTV() {
    console.log(
      `${this.name} sätter sig hemma i soffan på ${this.address} och tittar på tv`
    );
...
class Student extends Person {
  ...
  writeExam() {
    console.log(
      `${this.name} skriver tentamen i kursen ${this.course} och får betyg ${this.grade}`
    );
  }
}

const bill = new Person('Bill', '51', 'Solvägen 1');
const ellen = new Student(
  'Ellen',
  '28',
  'Månvägen 2',
  'grafisk formgivning',
